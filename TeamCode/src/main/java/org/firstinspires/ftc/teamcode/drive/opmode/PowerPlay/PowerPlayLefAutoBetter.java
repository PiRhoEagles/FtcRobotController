...
@Config
@Autonomous(name="PP: Left Auto", group="Power Play")
public class PowerPlayLefAutoBetter extends BaseAuto {

    public static customPose2D poleFirst = new customPose2D(55, -7, -30);
    public static customPose2D backFromPole = new customPose2D(40, 0, 0);
    public static customPose2D coneStack = new customPose2D(50, 27, 95, 40);
    ...
    public static customPose2D pole = new customPose2D(59, -6, -45);
        ...
        switch (detectionState) {
            case ONE:
                return drive.trajectorySequenceBuilder(new Pose2d(0,0,Math.toRadians(0)))
                        ...
                        .lineToSplineHeading(new Pose2d(42,1,Math.toRadians(-15))) // move near pole
                        ...
                        .waitSeconds(0.2) // wait for robot to stop shaking
                        ...
                        // move to pole and drop cone 2
                        .lineToSplineHeading(new Pose2d(facePole.x,facePole.y,Math.toRadians(facePole.h)))
                        .lineToSplineHeading(new Pose2d(pole.x+1,pole.y-1,Math.toRadians(pole.h)))
                        .waitSeconds(0.2) // wait for slides to stop shaking
                        .addTemporalMarker(() -> mechanism.openClaw())
                        .waitSeconds(0.3) // wait for grabber to open

                        //-----PARK-----
                        .lineToSplineHeading(new Pose2d(50,0,Math.toRadians(0))) // move to position 2
                        .addTemporalMarker(() -> mechanism.moveSlides(ScoringMechanism.slidePositions.FLOOR)) // move slides to floor
                        .strafeLeft(21) // move to position 1
            ...
            case THREE:
                return drive.trajectorySequenceBuilder(new Pose2d(0,0,Math.toRadians(0)))
                        ...
                        .lineToSplineHeading(new Pose2d(50,0,Math.toRadians(0))) // move to position 2
                        .addTemporalMarker(() -> mechanism.moveSlides(ScoringMechanism.slidePositions.FLOOR)) // move slides to floor
                        .strafeRight(21) // move to position 3
